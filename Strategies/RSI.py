...
class RSI():
    ...
    def calculate_vals(self,candle_list, n_periods):
        ...
        self.vals.append([candle_list[n_periods-1].get_start_time() , calc_rsi(avg_gains, avg_losses)])
        ...
        for i in range(n_periods, len(candle_list)):
            ...
            self.vals.append([candle_list[i].get_start_time(), calc_rsi(avg_gains, avg_losses)])
            
    def get_calculated_rsi_vals(self):
        return self.vals
    
def calc_rsi(avg_gains, avg_losses):
